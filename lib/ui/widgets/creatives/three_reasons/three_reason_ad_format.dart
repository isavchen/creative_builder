...
class ThreeReasonAdFormat extends StatelessWidget {
  final double scaleFactor;
  const ThreeReasonAdFormat({super.key, required this.scaleFactor});
        ...
        return Stack(
          ...
          children: [
            ...
            ThreeReasonTitleWidget(
              topOffset: scaleFactor * 60,
              scaleFactor: scaleFactor,
              textEditingController: titleController,
            ),
            Positioned(
              left: scaleFactor * 60,
              bottom: scaleFactor * 60,
