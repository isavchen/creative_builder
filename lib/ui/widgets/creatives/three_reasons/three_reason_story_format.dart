...
class ThreeReasonStoryFormat extends StatelessWidget {
  final double scaleFactor;
  const ThreeReasonStoryFormat({super.key, required this.scaleFactor});
        ...
        return Stack(
          ...
          children: [
            ...
            ThreeReasonTitleWidget(
              topOffset: scaleFactor * 300,
              scaleFactor: scaleFactor,
              textEditingController: titleController,
            ),
            Positioned(
              left: scaleFactor * 60,
              bottom: scaleFactor * 325,
